      ...
      >
        ...
        <div class="flex-1 min-w-0">
          ...
          <p
            ...
            class="text-xs text-theme-600 dark:text-theme-400 line-clamp-1"
          >
            {{ org.description }}
          </p>
          <p
            v-else
            class="text-xs text-theme-500 italic dark:text-theme-500"
          >
            No description
          </p>
        </div>
...
if (error.value) {
  console.error('Failed to load organizations:', error.value)
}
</script>
